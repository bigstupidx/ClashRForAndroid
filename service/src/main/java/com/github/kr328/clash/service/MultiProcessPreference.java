...
import static com.github.kr328.clash.service.PreferenceProvider.EXTRA_DATA;
import static com.github.kr328.clash.service.PreferenceProvider.EXTRA_EDITOR_ACTIONS;
import static com.github.kr328.clash.service.PreferenceProvider.EXTRA_EDITOR_KEYS;
import static com.github.kr328.clash.service.PreferenceProvider.EXTRA_EDITOR_VALUES;
import static com.github.kr328.clash.service.PreferenceProvider.EXTRA_RESULT;
import static com.github.kr328.clash.service.PreferenceProvider.METHOD_CONTAINS;
import static com.github.kr328.clash.service.PreferenceProvider.METHOD_EDITOR_APPLY;
import static com.github.kr328.clash.service.PreferenceProvider.METHOD_EDITOR_COMMIT;
import static com.github.kr328.clash.service.PreferenceProvider.METHOD_GET_ALL;
import static com.github.kr328.clash.service.PreferenceProvider.METHOD_GET_BOOLEAN;
import static com.github.kr328.clash.service.PreferenceProvider.METHOD_GET_FLOAT;
import static com.github.kr328.clash.service.PreferenceProvider.METHOD_GET_INT;
import static com.github.kr328.clash.service.PreferenceProvider.METHOD_GET_LONG;
import static com.github.kr328.clash.service.PreferenceProvider.METHOD_GET_STRING;
import static com.github.kr328.clash.service.PreferenceProvider.METHOD_GET_STRING_SET;
import static com.github.kr328.clash.service.PreferenceProvider.METHOD_REGISTER_LISTENER;
import static com.github.kr328.clash.service.PreferenceProvider.METHOD_UNREGISTER_LISTENER;
    ...
    public void registerOnSharedPreferenceChangeListener(OnSharedPreferenceChangeListener listener) {
        synchronized (mLock) {
            if (mListeners.isEmpty()) {
                ...
                BundleCompat.putBinder(extras, EXTRA_DATA, mListener.asBinder());
